...
public class EnemyType1 : EnemyMoveBetweenTwoPoint
{
    ...
    IEnumerator IEnumerator_Attack()
    {
       ...
       var tmp_attack = Instantiate(attackPrefab,shootPosition.position, Quaternion.Euler(0,0,(float)facing>0?45:135)).GetComponent<EnemyProjectile>();
       tmp_attack.direction =new Vector2(-1 * (float)facing,-1);
